...
exports.menuDetailsRepo = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const menudetails_schema_1 = require("../schemas/menudetails.schema");
let menuDetailsRepo = class menuDetailsRepo {
    constructor(menudetailsModel) {
...
menuDetailsRepo = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(menudetails_schema_1.menuDetails.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], menuDetailsRepo);
exports.menuDetailsRepo = menuDetailsRepo;
//# sourceMappingURL=menudetails.repo.js.map